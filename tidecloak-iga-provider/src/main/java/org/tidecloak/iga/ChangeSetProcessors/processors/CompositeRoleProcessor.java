...
public class CompositeRoleProcessor implements ChangeSetProcessor<TideCompositeRoleMappingDraftEntity> {
    ...
    public List<AccessProofDetailEntity> combineChangeRequests(KeycloakSession session, List<TideCompositeRoleMappingDraftEntity> compositeRoleEntities, EntityManager em) {
        ...
        Map<UserClientKey, List<AccessProofDetailEntity>> groupedChangeRequests =
                ChangeSetProcessor.super.groupChangeRequests(compositeRoleEntities, em);

        // Prepare lists to defer persistence/removal
        List<TideCompositeRoleMappingDraftEntity> modifiedEntities = new ArrayList<>();
        ...
        groupedChangeRequests.forEach((userClientAccess, accessProofs) -> {
            ...
            accessProofs.forEach(proof -> {
                try {
                    ...
                    TideCompositeRoleMappingDraftEntity entity =
                            (TideCompositeRoleMappingDraftEntity) IGAUtils.fetchDraftRecordEntityByRequestId(
        ...
        for (TideCompositeRoleMappingDraftEntity entity : modifiedEntities) {
            em.merge(entity);
        }
