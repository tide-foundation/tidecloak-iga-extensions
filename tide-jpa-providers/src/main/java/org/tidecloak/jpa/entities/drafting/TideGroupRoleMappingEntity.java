...
@NamedQueries({
        ...
        @NamedQuery(name="getAllPendingGroupRoleMappingsByRealm", query="select m from TideGroupRoleMappingEntity m where m.draftStatus <> :draftStatus and m.group IN (select g from GroupEntity g where g.realm=:realm)")
})
